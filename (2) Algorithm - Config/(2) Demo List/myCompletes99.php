...
$file = $myCompletes; include($php.'myData00-15.php');								//to run PID process for CronTab
if ($_lapse == 'true') {proc_nice(20); include($php.'myCompletes00.php');}					//to run process for demo list
