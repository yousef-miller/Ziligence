...
if (!empty($new1) && !empty($new2) && $new1 == $new2 && strpos($new1, $illegal) === false) {
    $_password = $new1; 
    $user_id = chr(rand(97, 122)).chr(rand(97, 122)).chr(rand(97, 122)).chr(rand(97, 122)).chr(rand(97, 122));
} //end if
else {$_password = trim($_POST[password]);}
